...
public enum Protocol {
    ...
    public static class DirectionData {
        ...
        {
            linkedProtocols.put(ProtocolConstants.MINECRAFT_1_5_2, Arrays.asList(
                    ProtocolConstants.MINECRAFT_1_5_2,
                    ProtocolConstants.MINECRAFT_1_6_4,
                    ProtocolConstants.MINECRAFT_1_7_2
            ));
            linkedProtocols.put(ProtocolConstants.MINECRAFT_1_6_4, Arrays.asList(
                    ProtocolConstants.MINECRAFT_1_5_2,
                    ProtocolConstants.MINECRAFT_1_6_4,
                    ProtocolConstants.MINECRAFT_1_7_2
            ));
