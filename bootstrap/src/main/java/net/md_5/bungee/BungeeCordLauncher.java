    ...
    public static void main(String[] args) throws Exception
    {
        ...
        if ( BungeeCord.class.getPackage().getSpecificationVersion() != null && System.getProperty( "IReallyKnowWhatIAmDoingISwear" ) == null)
        {
            ...
            } else
            {
                ...
                try
                {
                    URL api = new URL( "https://api.github.com/repos/ghacproductions/BungeeCord-IPForward/releases/latest" );
                    ...
                    try
                    {
                        ...
                        if ( latestVersion > currentVersion )
                        {
                            ...
                            System.err.println("*** Please download a new build from https://github.com/ghacproductions/BungeeCord-IPForward/releases ***");
